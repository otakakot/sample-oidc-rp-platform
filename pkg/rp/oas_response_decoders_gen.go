...
func decodeBeginResponse(resp *http.Response) (res BeginRes, _ error) {
	switch resp.StatusCode {
	case 302:
		// Code 302.
		var wrapper BeginFound
	...
	case 500:
		// Code 500.
		return &BeginInternalServerError{}, nil
	}
...
func decodeEndResponse(resp *http.Response) (res EndRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
	...
	case 500:
		// Code 500.
		return &EndInternalServerError{}, nil
	}
	return res, validate.UnexpectedStatusCode(resp.StatusCode)
}
